...
# Generation Time: 2013-12-16 16:11:55 +0000
# ************************************************************
...
# Dump of table poster_recommend_user_3
# ------------------------------------------------------------

DROP TABLE IF EXISTS `poster_recommend_user_3`;

CREATE TABLE `poster_recommend_user_3` (
  `id` bigint(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(11) unsigned NOT NULL DEFAULT '0',
  `status` tinyint(11) unsigned NOT NULL DEFAULT '0',
  `add_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
# Dump of table poster_recommend_user_4
# ------------------------------------------------------------

DROP TABLE IF EXISTS `poster_recommend_user_4`;

CREATE TABLE `poster_recommend_user_4` (
  `id` bigint(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(11) unsigned NOT NULL DEFAULT '0',
  `status` tinyint(11) unsigned NOT NULL DEFAULT '0',
  `add_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
