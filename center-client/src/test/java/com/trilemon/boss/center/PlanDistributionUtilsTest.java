 ...
 * @author kevin
 */
public class PlanDistributionUtilsTest {
    @Test
    public void testParseDistribution() throws Exception {
        Table<Integer, LocalTimeInterval, Integer> table = PlanDistributionUtils.parseAndFillZeroDistribution("{\"1\":{\"8\":false,\"9\":true},\"2\":{\"9\":true,\"10\":true}}");
    ...
    public void testGetDefaultDistribution_0() {
        Table<Integer, LocalTimeInterval, Integer> table = PlanDistributionUtils.getDefaultDistribution(0);
        assertTrue(table.isEmpty());
    }

    @Test
    public void testGetDefaultDistribution_1() {
        Table<Integer, LocalTimeInterval, Integer> table = PlanDistributionUtils.getDefaultDistribution(1);
        assertEquals(1, table.get(1, new LocalTimeInterval(9, 10)).intValue());
    }

    @Test
    public void testGetDefaultDistribution_15() {
        Table<Integer, LocalTimeInterval, Integer> table = PlanDistributionUtils.getDefaultDistribution(15);
        assertEquals(1, table.get(1, new LocalTimeInterval(9, 10)).intValue());
    ...
    public void testGetDefaultDistribution_98() {
        Table<Integer, LocalTimeInterval, Integer> table = PlanDistributionUtils.getDefaultDistribution(98);
        assertEquals(98, table.size());
    }

    @Test
    public void testGetDefaultDistribution_99() {
        Table<Integer, LocalTimeInterval, Integer> table = PlanDistributionUtils.getDefaultDistribution(99);
        assertEquals(98, table.size());
    ...
    public void testAssignItems() {
        ...
        Table<Integer, LocalTimeInterval, Integer> table = PlanDistributionUtils.getDefaultDistribution(items.size());
        Table<Integer, LocalTimeInterval, List<Item>> assignTable = PlanDistributionUtils.assignItems(items, table);
    ...
    public void testParseAndFillZeroDistribution_empty() throws Exception {
        Table<Integer, LocalTimeInterval, Integer> table = PlanDistributionUtils.parseAndFillZeroDistribution("");
        assertTrue(table.isEmpty());
    }
    ...
    public void testFindMinCellOfDistribution() throws Exception {
        ...
        Table.Cell<Integer, LocalTimeInterval, Integer> minCell=PlanDistributionUtils.findMinCellOfDistribution(table);
        assertEquals(1, minCell.getValue().intValue());
    }

    @Test
    public void testGetNewItemDistribution() throws Exception {
        Table<Integer, LocalTimeInterval, Integer> planDistribution= PlanDistributionUtils.getDefaultDistribution(10);

        Table<Integer, LocalTimeInterval, Integer> currDistribution=PlanDistributionUtils.parseAndFillZeroDistribution
        ...
        Table<Integer, LocalTimeInterval, Integer> table = PlanDistributionUtils.getNewItemDistribution
